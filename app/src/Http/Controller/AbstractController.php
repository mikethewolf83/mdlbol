...
abstract class AbstractController extends \Pop\Controller\AbstractController
{
    ...
    // Función helper para configurar el adaptador de archivo de la cache, 30 minutos de cache
    public function cacheFileAdapter()
    {
        // return $this->cache_file_adapter = new Adapter\File(__DIR__ . '/../../../../cache', 300);
        return $this->cache_file_adapter = new Adapter\File(APPDIR . '/cache', 1800);
    }

    // Función helper para configurar el motor de cache
    public function cacheEngine()
    {
        return $this->cache_engine = new Cache($this->cache_file_adapter);
    }
}