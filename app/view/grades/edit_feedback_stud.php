        ...
        <div class="box">
            <form class="pt-4 pb-6" id="edit-feedback-form" name="edit-feedback-form" action="<?= BASE_URL . $uri; ?>" method="POST">
                ...
                <div class="field mx-2">
                    ...
                    <div class="control">
                        <textarea id="edit-feedback" name="edit-feedback" class="textarea has-fixed-size <?= ($editFeedbackError || $formError) ? 'is-danger' : ''; ?>" rows="8" spellcheck="true" contenteditable="true" autofocus><?= $studentFeedback['feedback']; ?></textarea>
